      ...
      actions: [
        ...
        TextButton(
          ...
          onPressed: () {
            ...
            _modeIndex == 0
                ? addGeneralPost(
                    subject1, _body1Controller.text, widget.club.id, _body1Controller.text.hashCode.toString())
                : addMeetingPost(subject2, _body2Controller.text, meetingDate,
                    meetingTime, location, widget.club.id, _body2Controller.text.hashCode.toString());
          },
        ),
      ],
    );
